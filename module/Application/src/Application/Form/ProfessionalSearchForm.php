...
class ProfessionalSearchForm extends Form
{
    private $account;
    ...
    private function buildElements()
    {
        ...
        if ($this->account->getAddress() !== null
            && $this->account->getCity() !== null
        ) {
            $addressValue = $this->account->getAddress() . ', ' . $this->account->getCity();
        }
        elseif ($this->account->getCity() !== null) {
            $addressValue = $this->account->getCity();
        }
        
        $addressElement->setValue($addressValue);
