...
hairlov.professionnal.salon.manageImages = {
    init: function()
    {
        this.salonImageUploadForm.init();
    }
};
 ...
 */
hairlov.professionnal.salon.manageImages.salonImageUploadForm = {
    /*
    ...
    init: function()
    {        
        this.$imageUploadSuccessMsg = $('.js-salon-image-upload-success');
        this.$imageUploadRow = $('.js-salon-image-upload-dropzone-row');
        this.$imageUploadError = $('.js-salon-image-upload-dropzone-error');
        this.$imageUploadOverlay = $('.js-salon-image-upload-dropzone-overlay');
        this.$salonImageUploadPercentage = $('.js-salon-image-upload-dropzone-percentage');
        this.$imageUploadedList = $('.js-salon-image-list');
        this.$body = $('body');
        
        var self = this;
        
        $(".js-salon-image-upload-dropzone").fileupload({
    ...
    createUploadProgressListener: function()
    {
        ...
        return function(event, data) {
            ...
            self.$salonImageUploadPercentage.text(progress);
        };
    },
            ...
            var newImage = 
                        '<div class="col-xs-3 col-sm-3">'+
                            '<div class="thumbnail-with-delete-button overflow-image galerie-item grey">'+
                                ...
                                '<img src="/image/salon-image/'+ data.result.salonImageFilename +'" class="img-responsive"/>'+
                            '</div>'+
                        '</div>';
